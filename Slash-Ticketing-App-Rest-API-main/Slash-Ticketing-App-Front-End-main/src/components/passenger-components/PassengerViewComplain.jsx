...
class PassengerViewComplain extends Component {
    constructor(props) {
        super(props);
        this.state = {
          publishedComplaints: [],
    ...
    editAction(complaint) {
        window.sessionStorage.setItem("selectedComplainID:", complaint.id);
      }
                                                ...
                                                <tr key={complaint.id}>
                                                  ...
                                                  <td>{complaint.userId}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        onClick={() => this.editAction(complaint)}
                                                         >
                                                         <a href="/editcomplain">
...
export default PassengerViewComplain;
