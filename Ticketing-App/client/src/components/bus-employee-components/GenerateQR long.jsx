...
class GenerateQrlong extends Component {
    constructor(props) {
        super(props);
        this.state = {
            UserId: "",
                    ...
                    <div className="col-lg-12 mt-5">
                        <div className="card">
                            <div className="card-body">
                                <div>
                                    <h2 className="header-title">Generate QR for Long Term</h2>
                                </div>
                                <br/>
                                <form
                                    autoComplete="off"
                                ...
                                >
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="exampleInputEmail1">Seasion Validate Periyod</label>
                                                <input
                                                    type="number"
                                                    className="form-control style-input"
                                                    placeholder="Days You Need this Pass"
                                                    name="amount"
                                                    onChange={(event) => {
